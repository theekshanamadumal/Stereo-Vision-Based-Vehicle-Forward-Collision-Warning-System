...
path.test_path = "./data/kitti_obj/testing"
#".data/kitti_seq/2011_09_26_drive_0052_sync"#./data/kitti_obj/testing" # used in visualDet3D/data/.../dataset
...
data = edict(
    ...
    test_split_file   = os.path.join(cfg.path.visualDet3D_path, 'data', 'kitti', 'test_split', 'test.txt'),
)

# #local
data.augmentation = edict(
    rgb_mean = np.array([0.4945401 , 0.54598683, 0.52165573]),
    rgb_std  = np.array([0.23436193, 0.2540338 , 0.27605338]),
...
# #carla
# data.augmentation = edict(
#     rgb_mean = np.array([0.51332268, 0.48173237, 0.45552908]),
#     rgb_std  = np.array([0.17050099, 0.16690658, 0.16215306]),
#     cropSize = (data.rgb_shape[0], data.rgb_shape[1]),
#     crop_top = 900,
# )
...
CARLA_P2_0 = np.array([[ 7.215377000000e+02, 0.000000000000e+00, 6.095593000000e+02, 4.485728000000e+01,],
                 [0.000000000000e+00, 7.215377000000e+02, 1.728540000000e+02, 2.163791000000e-01,],
                 [0.000000000000e+00, 0.000000000000e+00, 1.000000000000e+00, 2.745884000000e-03],])
                
CARLA_P3_0 = np.array([[ 7.215377000000e+02, 0.000000000000e+00, 6.095593000000e+02, -3.395242000000e+02,],
                 [ 0.000000000000e+00, 7.215377000000e+02, 1.728540000000e+02, 2.199936000000e+00,],
                 [ 0.000000000000e+00, 0.000000000000e+00, 1.000000000000e+00, 2.729905000000e-03],])

#camera callibaration data of stereo camera
LOCAL_P2_0 = np.array([[ 7.215377000000e+02, 0.000000000000e+00, 6.095593000000e+02, 4.485728000000e+01,],
                 [0.000000000000e+00, 7.215377000000e+02, 1.728540000000e+02, 2.163791000000e-01,],
                 [0.000000000000e+00, 0.000000000000e+00, 1.000000000000e+00, 2.745884000000e-03],])
                
LOCAL_P3_0 = np.array([[ 7.215377000000e+02, 0.000000000000e+00, 6.095593000000e+02, -3.395242000000e+02,],
                 [ 0.000000000000e+00, 7.215377000000e+02, 1.728540000000e+02, 2.199936000000e+00,],
                 [ 0.000000000000e+00, 0.000000000000e+00, 1.000000000000e+00, 2.729905000000e-03],])